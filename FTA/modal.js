/**
 * modal.js
 * Functional Analysis Studio [FAS] — Shared modal overlay primitive.
 *
 * One overlay element, reused by every dialog (event properties, gate
 * editor, group editor, scenario editor, confirm-delete). Keeping this
 * tiny and shared stops dialogs.js from growing unmanageably.
 *
 * Public:
 *   modal.init()
